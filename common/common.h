...
struct common_params_speculative_draft {
    ...
    int adaptive_length_threshold = 0; // Number of consecutive successes (failures) before increasing (decreasing) the size of the draft by one
    int adaptive_length_bias = 0; // Number of consecutive successes (failures) before increasing (decreasing) the size of the draft by one
